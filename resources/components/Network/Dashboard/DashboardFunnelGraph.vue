...
export default {
    ...
    data() {
      return {
          sum: null,
          labels: ['Commissions - $', 'Clicks', 'Leads', 'Conversion Rate - %'],
          colors: [
              ['#f32cfb', '#9814fd'], // color set for "Impressions" segment
          ],
          values: [
            [this.statistics.commisions],[this.statistics.clicks],[this.statistics.leads],[(this.statistics.leads / this.statistics.clicks * 100)]
          ],
