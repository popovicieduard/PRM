<template>
    <el-card>
        ...
        <el-row :gutter="12" class="card-row">
            <el-col :span="24">
                <h4 class="font-weight-bold">Statistics for - {{ $moment(date).format('DD MMMM YYYY ')}}</h4>
            </el-col>
                        ...
                        <el-card shadow="hover">
                            <el-row>
                                <el-col :span="18">
                                    ...
                                    <h3 class="card-row__numbers text-success">{{ stats.spend | numFormat('0,0.00') }} USD</h3>
                                </el-col>
                        ...
                        <el-card shadow="hover">
                            <el-row>
                                <el-col :span="18">
                                    ...
                                    <h3 class="card-row__numbers">{{ stats.clicks }}</h3>
                                </el-col>
                                <el-col :span="6" class="text-center">
                        ...
                        <el-card shadow="hover">
                            <el-row>
                                <el-col :span="18">
                                    ...
                                    <h3 class="card-row__numbers">{{ stats.leads }}</h3>
                                </el-col>
                                <el-col :span="6" class="text-center">
                                    <i class="icon-lead"></i>
                                </el-col>
                        ...
                        <el-card shadow="hover">
                            <el-row>
                                <el-col :span="18">
                                    ...
                                    <h3 class="card-row__numbers">{{ stats.conversionRate }}%</h3>
                                </el-col>
                                <el-col :span="6" class="text-center">
