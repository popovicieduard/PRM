<template>
    <el-card>
        <div slot="header">
            ...
            <nuxt-link :to="{name: 'advertiser-campaigns-campaignId-edit', params:{campaignId: campaign.id}}"><el-button class="float-right bg-info text-white border-0" size="mini">Edit Campaign</el-button></nuxt-link>
            <el-alert v-if="campaign.tested == false" type="warning" :closable="false" class="my-4" :title="'The Campaign is in testing phase, in order to start the campaign a test POST callback / postback has to be made at the following URL: https://upboost.io/api/postback/' + campaign.id + '/test'"></el-alert>        
        </div>
        <el-row :gutter="36">
            <el-col :span="12">
                    ...
                    <div style="padding: 14px;">
                        ...
                        <hr>
                            ...
                            <el-row>
                                ...
                                <el-col :span="14">
                                    <el-tag type="primary" effect="dark" class="text-capitalize ml-1" size="medium">{{ campaign.conversionGoal }}</el-tag>                                    
                                </el-col>
                            </el-row>
                            <hr>
                            <el-row>
